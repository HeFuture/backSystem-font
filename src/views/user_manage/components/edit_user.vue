<template>
    <div>
        <el-dialog v-model="dialogFormVisible" title="编辑用户信息" width="600" align-center :draggable="true">
...
const rules = reactive({
    ...
    */
    name: [
        { required: true, message: '请输入要修改的姓名', trigger: 'blur' },
    ],
    sex: [
    ...
    department: [
        { required: true, message: '请选择要修改的部门', trigger: 'blur' },
    ]
})
